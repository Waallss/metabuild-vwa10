...
import { OnchainMetaverseCreator } from "@/components/onchain-metaverse-creator"
...
const mockMetaverses: MetaverseNFT[] = [
  ...
  },
  {
    ...
    image: "/chile-fintech-forum-2025.png",
  ...
  },
  {
    ...
    image: "/la-cumbre-digital-2025.png",
    organizer: "Aleph",
          ...
          <div className="flex-1">
            {showCreateForm && (
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-2xl font-bold text-foreground">Create New Metaverse</h2>
                  <Button variant="ghost" size="sm" onClick={() => setShowCreateForm(false)}>
                    <X className="w-4 h-4" />
                  </Button>
                </div>
                <OnchainMetaverseCreator />
              </div>
            )}
            ...
            {!showCreateForm && (
              <div className="mb-6 flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-2">Metaverse Projects</h2>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid md:grid-cols-2 xl:grid-cols-2 gap-6">
                    {filteredMetaverses.map((metaverse) => (
            ...
            {!showCreateForm && filteredMetaverses.length === 0 && (
