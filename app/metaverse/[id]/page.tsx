...
const mockMetaverses: Record<string, MetaverseNFT> = {
  "1": {
    ...
    tokenName: "Chile Fintech Forum by MetaBuild HUB",
    tokenSymbol: "$CFF",
...
const spatialIframes: Record<string, { url: string; shareUrl: string }> = {
  "1": {
    url: "https://www.spatial.io/embed/Chile-Fintech-Forum-2025-6805e30ef734432bbfb0aa50?share=1958515338604272350&autoplay=1&enableRtc=1",
    shareUrl: "https://www.spatial.io/s/Chile-Fintech-Forum-2025-6805e30ef734432bbfb0aa50?share=1958515338604272350",
  },
  "2": {
    url: "https://www.spatial.io/embed/La-Cumbre-Digital-2025-68689b2a72cf55d3b7251f6f&autoplay=1&enableRtc=1",
    shareUrl: "https://www.spatial.io/s/La-Cumbre-Digital-2025-68689b2a72cf55d3b7251f6f",
  },
  "3": {
    url: "https://www.spatial.io/embed/HUB-Aleph-66d432c2fd1fcb960ca9012d?share=30210623261239156&autoplay=1&enableRtc=1",
    shareUrl: "https://www.spatial.io/s/HUB-Aleph-66d432c2fd1fcb960ca9012d?share=30210623261239156",
  },
  "4": {
    url: "https://www.spatial.io/embed/Studio-Aleph-66d96f185434896cb73b456a?share=6929305246711733759&autoplay=1&enableRtc=1",
    shareUrl: "https://www.spatial.io/s/Studio-Aleph-66d96f185434896cb73b456a?share=6929305246711733759",
  },
  "5": {
    url: "https://www.spatial.io/embed/Wellness-Aleph-66d9f7735434896cb73b4584?share=7260458631188805103&autoplay=1&enableRtc=1",
    shareUrl: "https://www.spatial.io/s/Wellness-Aleph-66d9f7735434896cb73b4584?share=7260458631188805103",
  },
}
...
export default function MetaverseDetailPage() {
  ...
  const isChileFintech = metaverse?.id === "1"

  const spatialData = spatialIframes[metaverse?.id || ""]
                ...
                <CardContent>
                  <div className="space-y-4">
                    <p className="text-muted-foreground">
                      Immerse yourself in the {metaverse.name} virtual experience powered by Spatial.
                    </p>
                    <div className="w-full aspect-video rounded-lg overflow-hidden border border-border">
                      <iframe
                        ...
                        className="border-0"
                        title={`${metaverse.name} - Spatial Experience`}
                      />
                    </div>
                    <div className="flex gap-2">
                      <Button
                        onClick={() => window.open(spatialData.shareUrl, "_blank")}
